...
def print_multiples_in_range(min_number, max_number, multiple):
    """
    Prints multiples of given number in specified range
    """
...
print_multiples_in_range(7, 77, 17)
print(print_multiples_in_range.__doc__)
